...
| Tuesdays <br> (4-6pm) & <br> Thursdays <br> (5-6pm) | [Introduction to English Linguistics]() | UG <br> (2nd Year) | 3 | English Linguistics covers phonetics, phonology, morphology, syntax, semantics, and pragmatics, providing basic understanding of the English language for English education majors. It enables them to better understand linguistic backgrounds of their students and work with English language learners.| |
